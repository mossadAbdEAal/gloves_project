          ...
          const CircleAvatar(
            ...
            child: IconButton(
                ...
                icon: Icon(Icons.person,
                    size: 160, color: Color.fromARGB(255, 29, 45, 68))),
          ),
          Padding(
                ...
                child: IconButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => ViewStatsScreen()),
                      );
                    },
                    icon: const Icon(
                      Icons.bar_chart,
                ...
                child: IconButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => LearningGoalsEmptyScreen()),
                      );
                    },
                    icon: const Icon(
                      Icons.track_changes,
                  ...
                  child: DropdownButtonFormField<String>(
                    ...
                    decoration: InputDecoration(
                      ...
                      labelStyle: const TextStyle(
                        color: const Color.fromRGBO(29, 45, 68, 1),
                      ),
                      border: OutlineInputBorder(
                        borderSide: const BorderSide(color: Colors.grey),
                        borderRadius: BorderRadius.circular(10),
...
class HelpSupportScreen extends StatelessWidget {
  final List<Map<String, dynamic>> categories = [
    ...
    },
    {
      ...
      "screen": TechnicalInformationScreen()
    },
    {
      "title": "Enhancements",
      "icon": Icons.attach_money,
      "color": Colors.red[200],
      "screen": EnhancementsScreen()
    },
    {
  ...
  final List<Map<String, String>> topQuestions = [
    ...
    },
    {
      ...
      "content":
          "The app helps translate sign language gestures into text and speech."
    },
    {
  ...
  Widget _buildExpansionTile({
    ...
    return Consumer<UiProvider>(
      ...
      return Card(
        ...
        color: notifier.isDark ? Color.fromRGBO(29, 45, 68, 1) : Colors.white,
  ...
  final List<Map<String, String>> generalQuestions = [
    {
      ...
      "content":
          "The Smart Glove is an innovative device designed to translate sign language gestures into text or speech "
              "using advanced motion sensors. "
              "It connects to a mobile app for real-time processing and feedback."
    },
    {
      "title":
          "Is the glove compatible with all devices and operating systems?",
      "content":
          "The Smart Glove app is compatible with iOS and Android devices, requiring Bluetooth connectivity."
    ...
    },
    {
      ...
      "content":
          "Yes, users can set daily reminders for practice sessions and earn badges for achieving milestones."
    },
  ];
...
class TechnicalInformationScreen extends StatelessWidget {
  final List<Map<String, String>> generalQuestions = [
    ...
    },
    {
      ...
      "content":
          "The Smart Glove uses Bluetooth technology to pair with the mobile app."
              " Ensure Bluetooth is enabled on your device."
    },
    {
      "title": "Can I use the glove without the app?",
      "content":
          "The app is required for translation, gesture tracking, and accessing additional features. However,"
  ...
  final List<Map<String, String>> generalQuestions = [
    {
      ...
      "content":
          "We’re continually adding new gesture libraries and expanding to support more sign languages."
              " Updates will be announced via the app or email."
    },
    {
      "title": "Can the app integrate with third-party software? ",
      "content":
          "Yes, integrations with accessibility tools and platforms like speech-to-text software are supported in the app."
    },
  ];
  ...
  final List<Map<String, String>> generalQuestions = [
    {
      ...
      "content":
          "Ensure the glove is charged, and Bluetooth is enabled on your device."
              " Restart both the glove and app, and try reconnecting."
    },
    {
      "title": "Why are gestures not recognized correctly?",
      "content":
          "Check if the glove is worn properly and recalibrate the sensors in the app. "
              "Ensure no obstructions block the sensors."
    },
    {
      "title": "What should I do if the app crashes?",
      "content":
          "Update the app to the latest version, clear its cache, and restart your device. If the issue persists, contact support."
    },
  ];
  ...
  final List<Map<String, String>> generalQuestions = [
    {
      ...
      "content":
          "Yes, the app encrypts all data in transit and at rest, ensuring your privacy and security."
    },
    {
      "title": "Does the app share data with third parties?",
      "content":
          "No personal data is shared with third parties without user consent. Only aggregated,"
              " anonymized data may be used for research."
    },
    {
      "title": "Can I delete my data?",
      "content":
          "Yes, users can delete their accounts and all associated data through the app’s 'Privacy' section"
    },
  ];
  ...
  final List<Map<String, String>> generalQuestions = [
    {
      "title": "What is the Smart Glove, and how does it work?",
      "content":
          "The Smart Glove is an innovative device designed to translate sign language gestures into text or speech using advanced motion sensors. "
              "It connects to a mobile app for real-time processing and feedback."
    },
    {
      "title":
